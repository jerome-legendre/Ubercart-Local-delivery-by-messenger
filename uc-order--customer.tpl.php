 ...
 */
			...
			<h2>" . t("Livraison au client") . "</h2>
			<h3>Le ". format_date( _uc_messenger_extract_creneauHoraire( $order->data['LIVRAISONcreneauHoraire'] , 'timestamp') , 'court') . "</h3>
			<p><i>Commentaire du client:</i><br />" . $order->data['LIVRAISONcommentaire'] . "</p>
			";
?>
<table width="95%" border="0" cellspacing="0" cellpadding="1" align="center" bgcolor="#b00a0c" style="font-family: verdana, arial, helvetica; font-size: small;">
  <tr>
    <td>
      <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" bgcolor="white" style="font-family: verdana, arial, helvetica; font-size: small;">
        ...
        <tr valign="top">
          <td>
	          <p style="display:none;">[uc_order:ucwf_212]</p>
...
<hr />
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              <tr>
                <td colspan="2" bgcolor="#b00a0c" style="color: white;">
